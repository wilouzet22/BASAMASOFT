    ...
    <nav class="bg-white shadow-md fixed w-full z-50 top-0">
            ...
            <div class="flex justify-between h-16">
                <div class="flex items-center">
                    <a href="#" class="flex-shrink-0 flex items-center">
                        <img class="h-10 w-auto rounded-full" src="assets/img/logo.png" alt="EduSaft Logo">
                        <span class="ml-2 font-bold text-xl text-gray-800">EduSaft</span>
                    </a>
                    <div class="hidden md:ml-6 md:flex md:space-x-8">
                        <a href="#" class="text-gray-900 inline-flex items-center px-1 pt-1 border-b-2 border-blue-500 text-sm font-medium">Inicio</a>
                ...
                <div class="hidden md:flex items-center">
                    <?php if ($isLoggedIn): ?>
                        <div class="ml-3 relative flex space-x-4">
                            ...
                            <a href="padres/dashboard.php" class="text-blue-600 hover:text-blue-800 text-sm font-medium">Mi Perfil</a>
                        </div>
                    <?php else: ?>
                        <a href="login.php" class="text-gray-500 hover:text-gray-900 px-3 py-2 rounded-md text-sm font-medium flex items-center">
        ...
        <div class="hidden md:hidden bg-white border-t" id="mobile-menu">
            ...
            <div class="pt-4 pb-4 border-t border-gray-200">
                <?php if ($isLoggedIn): ?>
                    <div class="space-y-1">
                        <a href="padres/dashboard.php" class="block px-4 py-2 text-base font-medium text-gray-500 hover:text-gray-800 hover:bg-gray-100">Mi Perfil</a>
                        ...
                        <a href="api/logout.php" class="block px-4 py-2 text-base font-medium text-red-500 hover:text-red-700 hover:bg-gray-100">Cerrar Sesión</a>
                    </div>
                <?php else: ?>
                    <div class="space-y-1">
                        <a href="login.php" class="block px-4 py-2 text-base font-medium text-gray-500 hover:text-gray-800 hover:bg-gray-100 flex items-center">
